    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <p class="text-danger">*Please refer to the community rules for architectural request guidelines.</p>
                <br>
                <div class="formmm">
                    <div class="formss">
                        <div class="card-body">
                            <form action="{{ route('member.architectural.save') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="fullName" class="form-label">Name Of Homeowner</label>
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ old('name') }}" placeholder="Tony Nguyen">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" name="phone" id="phoneNumber"
                                        value="{{ old('phone') }}" placeholder="+1 3934 3445 33">
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label">Email Of Homeowner</label>
                                    <input type="email" class="form-control" name="email" id="email"
                                        value="{{ old('email') }}" placeholder="tony@example.com">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="requestedchange" id="Requested"
                                        value="{{ old('requestedchange') }}" placeholder="Type Here">
                                </div>
