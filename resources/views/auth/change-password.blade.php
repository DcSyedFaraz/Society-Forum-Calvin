@extends(auth()->user()->hasRole('admin') ? 'admin.layouts.app' : (auth()->user()->hasRole('executive') ? 'executive.layouts.app' : (auth()->user()->hasRole('agent') ? 'real_estate.layouts.app' : 'member.layouts.app')))
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('store_change_password') }}" method="post" class="validatedForm"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <code>*</code>
                                            <input name="newpassword" id="password" minlength="8" type="password"
                                                class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Confirm Password</label>
                                            <code>*</code>
                                            <input name="password_confirmation" data-rule-equalTo="#password"
...
@push('css')
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/backend_assets/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}">
