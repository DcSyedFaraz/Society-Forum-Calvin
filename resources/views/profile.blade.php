            ...
            <div class="row">
                <div class="col-sm-6 col-xl-5 col-lg-6" style="background:#fff;border-radius: 9px;">
                    <div class="modal-body">
                        <form role="form" action="{{ route('user.deposit.store') }}" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" class="form-check-input" name="dmethod" id="sc1"
                                            value="SweepCoins" required="">
                                        <label class="form-check-label" for="sc1">SweepCoins ($0)</label>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <div class="form-check form-check-inline">
                                        <input type="radio" class="form-check-input" name="dmethod" id="rsc1"
