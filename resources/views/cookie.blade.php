...
@section('content')
    ...
    <section class="main-div">
        <div class="col-12 col-md-10 cookie">
            <!--<h1 class="heading1">PARK SHADOWS HOA COOKIE POLICY</h1>-->
            <img src=" {{ asset('frontend/images/circle.png') }}" class="circle">
            <p class="paragraph">
                This Cookie Policy explains how we use cookies and similar technologies to enhance your experience on our
                website while respecting your privacy. By using our website, you consent to the use of cookies in accordance
                with this policy.<br><br>
            ...
            Cookies help us provide you with a personalized experience by remembering your preferences and settings. For
            example, they remember your login details, language preferences, and display settings.<br><br>

            <strong>ANALYZING WEBSITE PERFORMANCE: </strong><br>
            We use cookies to analyze how visitors use our website, which helps us improve its performance and
            functionality. These cookies collect anonymous information about visitor behavior, such as the number of
            visitors to the website and the pages they visit most often.<br><br>

            <strong>THIRD PARTY INTEGRATIONS:</strong> <br>
            Some cookies may be placed by third-party services that appear on our website. These cookies are used for
            purposes such as analyzing website traffic, delivering targeted advertisements, and providing social media
            features.<br><br>

            <strong>YOUR PRIVACY:</strong><br>

            We respect your privacy and are committed to protecting your personal information. We do not sell, trade, or
            otherwise transfer your personal information to third parties without your consent. Any information collected
            through cookies is used solely for the purposes outlined in this policy.<br><br>

            <strong>MANAGING COOKIES:</strong><br>

            You can control and manage cookies in various ways. Most web browsers allow you to accept or reject cookies,
            delete existing cookies, and set preferences for future cookie usage. Please note that disabling cookies may
            affect your experience on our website and limit certain functionalities.
            <br><br>


            <strong>CHANGES TO THIS POLICY</strong><br>

            We may update this Cookie Policy from time to time to reflect changes in our practices or legal requirements. We
            encourage you to review this policy periodically for any updates or changes.<br><br>

            <strong>CONTACT US</strong><br>

            If you have any questions or concerns about our use of cookies or this Cookie Policy, please contact us at
            parkshadowshomeowners@gmail.com<br><br>
